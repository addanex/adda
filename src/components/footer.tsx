...
export default function Footer() {
  return (
    <footer className="w-full pt-16 px-4">
      <div className="w-full max-w-400 mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
        {/* Brand column */}
      ...
      {/* Bottom bar */}
      <div className="w-full max-w-6xl mx-auto border-t border-gray-200 mt-12 py-6 text-center">
        <p className="text-sm text-gray-500">
          © {new Date().getFullYear()} Copyright by IK Developers. All rights
          reserved.
        </p>
      </div>
    </footer>
